...
locals {
  ...
  # Full image name in Azure Container Registry
...
locals {
  ...
  provisioning_script_content = var.is_frontend ? templatefile(local.frontend_script_path, {
    ...
    managed_identity_client_id = azurerm_user_assigned_identity.vmss_identity.client_id
...
# Allow VMSS Managed Identity to pull images from ACR
